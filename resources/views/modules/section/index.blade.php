...
<div class="content">
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            {{-- @ability('Admin', 'add_section') --}}
            <button type="button" class="btn btn-outline-primary push" data-toggle="modal" data-target="#add-modal">Add New Section</button>
            {{-- @endability --}}
        </div>
...
@include('section::includes._modal_edit')
@include('section::includes._modal_add')
@endsection
@section('styles')
...
<script>
    ...
    $(document).on('click', '[id=btn-edit]', function(){
        var id = $(this).data('id');
        var show_route = '{{ route('section.show', ':id') }}';
        var update_route = '{{ route('section.update', ':id') }}';
