...
class GlobalSettingServiceProvider extends ServiceProvider
{
    ...
    public function registerViews()
    {
        ...
        $this->loadViewsFrom(resource_path('views/modules/section'), 'section');
        $this->loadViewsFrom(resource_path('views/modules/employment_type'), 'employment_type');
        $this->loadViewsFrom(resource_path('views/modules/holiday_type'), 'holiday_type');
        $this->loadViewsFrom(resource_path('views/modules/designation'), 'designation');
        $this->loadViewsFrom(resource_path('views/modules/leave'), 'leave');
